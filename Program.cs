...
foreach (string name in studentNames)
{
    ...
    */
    ...
    extraStudentGrade = (decimal)(sumExtraScores) / extraAssignments;

    extraStudentPoints = (decimal)(sumExtraScores) / 10 / examAssignments;

    decimal overallStudentGrade = currentStudentGrade + extraStudentPoints;
    ...
    Console.WriteLine($"{currentStudent}\t\t{currentStudentGrade}\t\t{overallStudentGrade}\t{currentStudentLetterGrade}\t{extraStudentGrade} ({extraStudentPoints} pts)");
}
